...
def beli():
    ...
    try:
        ...
        requests.post(url, data={"chat_id": CHAT_ID, "text": pesan_tele}, timeout=10)
        return render_template_string(HTML, produk=produk, pesan=f"✅ Terima kasih {nama}! Order berhasil!", sukses=True)
    except:
        return render_template_string(HTML, produk=produk, pesan="❌ Gagal kirim notif!", sukses=False)
